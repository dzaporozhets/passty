  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved password as @password" do
        ...
        post :create, {:password => { "title" => "invalid value" }}, valid_session
        assigns(:password).should be_a_new(Password)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested password" do
        ...
        Password.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => password.to_param, :password => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the password as @password" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Password.any_instance.stub(:save).and_return(false)
        put :update, {:id => password.to_param, :password => { "title" => "invalid value" }}, valid_session
        assigns(:password).should eq(password)
      end
